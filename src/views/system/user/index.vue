  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="状态" class-name="status-col" width="100">
        <template slot-scope="{row}">
          <el-tag :type="row.enabled | enabledFilter">
            {{ row.enabled }}
          </el-tag>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" width="230" class-name="small-padding fixed-width">
        <template slot-scope="{row,$index}">
          ...
          <el-button v-if="row.enabled!='enabled'" size="mini" type="success" @click="handleModifyStatus(row,'enabled')">
            启用
          </el-button>
          <el-button v-if="row.enabled!='disabled'" size="mini" @click="handleModifyStatus(row,'disabled')">
            禁用
          </el-button>
